            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="post-container">
                        ...
                        LEFT JOIN user ON post.author=user.user_id WHERE category_id=$category ORDER BY post.post_id DESC LIMIT $offset,$limit ";
                    ...
                    $sql1="Select * From post LEFT JOIN category ON post.category=category.category_id
                        LEFT JOIN user ON post.author=user.user_id WHERE category_id=$category ";
                    ...
                    for($i=1;$i<=$total_page;$i++){
                          if($i==$page){
                        echo "<li class='active ' ><a href='category.php?page=$i&category=$category'> $i</a></li>";
                    }
                    else{
                        echo "<li class='' ><a href='category.php?page=$i&category=$category'> $i</a></li>";
                    }
                }
                    }?>
                    </ul>
